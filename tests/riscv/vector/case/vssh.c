...
int main(void)
{
    init_testsuite("Testing insn vssh\n");

    /* sew 16 */
    test_vssh_16(vlmax_16 / 2, &pad.fixs16[0], src0[0].fixs16[0], res0.fixs16[0]);
    result_compare_s16_lmul(res0.fixs16[0], dst0[0].fixs16[0]);

    test_vssh_16_vm(vlmax_16 / 2, &vme.fixs16, &pad.fixs16[0], src0[0].fixs16[0], res0.fixs16[0]);
    result_compare_s16_lmul(res0.fixs16[0], dst0[1].fixs16[0]);

    test_vssh_16_vm(vlmax_16 / 2, &vmo.fixs16, &pad.fixs16[0], src0[0].fixs16[0], res0.fixs16[0]);
    result_compare_s16_lmul(res0.fixs16[0], dst0[2].fixs16[0]);

    /* sew 32 */
    test_vssh_32(vlmax_32 / 2, &pad.fixs16[0], src0[0].fixs32[0], res0.fixs16[0]);
    result_compare_s16_lmul(res0.fixs16[0], dst1[0].fixs16[0]);

    test_vssh_32_vm(vlmax_32 / 2, &vme.fixs32, &pad.fixs16[0], src0[0].fixs32[0], res0.fixs16[0]);
    result_compare_s16_lmul(res0.fixs16[0], dst1[1].fixs16[0]);

    test_vssh_32_vm(vlmax_32 / 2, &vmo.fixs32, &pad.fixs16[0], src0[0].fixs32[0], res0.fixs16[0]);
    result_compare_s16_lmul(res0.fixs16[0], dst1[2].fixs16[0]);

    /* sew 64 */
    test_vssh_64(vlmax_64 / 2, &pad.fixs16[0], src0[0].fixs64[0], res0.fixs16[0]);
    result_compare_s16_lmul(res0.fixs16[0], dst2[0].fixs16[0]);

    test_vssh_64_vm(vlmax_64 / 2, &vme.fixs64, &pad.fixs16[0], src0[0].fixs64[0], res0.fixs16[0]);
    result_compare_s16_lmul(res0.fixs16[0], dst2[1].fixs16[0]);

    test_vssh_64_vm(vlmax_64 / 2, &vmo.fixs64, &pad.fixs16[0], src0[0].fixs64[0], res0.fixs16[0]);

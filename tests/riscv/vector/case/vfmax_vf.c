...
struct rvv_reg dst_vl[] = {
    {
        ...
        .float32 = {
            {0x483471f7, 0x46f2e02b, 0xc785dc35, 0x47ad69d9,},
            {0x483471f7, 0x46f2e02b, 0xc843ca22, 0x00000000,},
        },
        .float16 = {
            {0x4aee, 0x40aa, 0xc524, 0x46a9, 0x4a65, 0x404e, 0xc4bf, 0x4626,},
            {0x4aee, 0x40aa, 0xc524, 0x46a9, 0x4a65, 0x404e, 0xc4bf, 0x0000,},
        },
    },
};
...
struct rvv_reg dst_even[] = {
    {
        ...
        .float32 = {
            ...
            {0x483471f7, 0x11111111, 0xc843ca22, 0x11111111,},
        },
        .float16 = {
...
struct rvv_reg dst_odd[] = {
    {
        .float64 = {
            {0x1111111111111111, 0x402b982fa8cba1c2,},
            {0x1111111111111111, 0x402b982fa8cba1c2,},
        },
        .float32 = {
...
int main(void)
{
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vfmax_vf_64(vlmax_64 - 1, src0[i].float64[0],
                src1[i].float64[0][0], res.float64[0], pad.fixu64);
        result_compare_s64_lmul(res.float64[0], dst_vl[i].float64[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vfmax_vf_64_vm(src0[i].float64[0], src1[i].float64[0][0],

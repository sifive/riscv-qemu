...
{
    int i = 0;
    init_testsuite("Testing insn vsaddu.vx\n");

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vsaddu_vx_8(vlmax_8 - 1, src0[i].fixu8[0], src1_u8, res.fixu8[0],
                pad.fixu8[0]);
        result_compare_u8_lmul(res.fixu8[0], dst_vl[i].fixu8[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vsaddu_vx_8_vm(src0[i].fixu8[0], src1_u8, res.fixu8[0],
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vsaddu_vx_16(vlmax_16 - 1, src0[i].fixu16[0],
                src1_u16, res.fixu16[0], pad.fixu16[0]);
        result_compare_u16_lmul(res.fixu16[0], dst_vl[i].fixu16[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vsaddu_vx_16_vm(src0[i].fixu16[0], src1_u16, res.fixu16[0],
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vsaddu_vx_32(vlmax_32 - 1, src0[i].fixu32[0],
                src1_u32, res.fixu32[0], pad.fixu32[0]);
        result_compare_u32_lmul(res.fixu32[0], dst_vl[i].fixu32[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vsaddu_vx_32_vm(src0[i].fixu32[0], src1_u32, res.fixu32[0],
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vsaddu_vx_64(vlmax_64 - 1, src0[i].fixu64[0],
                src1_u64, res.fixu64[0], pad.fixu64[0]);
        result_compare_u64_lmul(res.fixu64[0], dst_vl[i].fixu64[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vsaddu_vx_64_vm(src0[i].fixu64[0], src1_u64, res.fixu64[0],

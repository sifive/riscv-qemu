...
int main(void)
{
    int16_t *binv, *brw, *start;
    int pagesize;
    pagesize = sysconf(_SC_PAGESIZE);
    int i, vl;
    init_testsuite("Testing insn vlhff\n");

    /* sew 16 */
    test_vlhff_16(vlmax_16 - 1, &pad.fixs16[0], src0[0].fixs16[0], res0.fixs16[0]);
    result_compare_s16_lmul(res0.fixs16[0], dst0[0].fixs16[0]);

    test_vlhff_16_vm(&vme.fixs16, &pad.fixs16[0], src0[0].fixs16[0], res0.fixs16[0]);
    result_compare_s16_lmul(res0.fixs16[0], dst0[1].fixs16[0]);

    test_vlhff_16_vm(&vmo.fixs16, &pad.fixs16[0], src0[0].fixs16[0], res0.fixs16[0]);
    result_compare_s16_lmul(res0.fixs16[0], dst0[2].fixs16[0]);

    /* sew 32 */
    test_vlhff_32(vlmax_32 - 1, &pad.fixs32[0], src0[0].fixs16[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[0].fixs32[0]);

    test_vlhff_32_vm(&vme.fixs32, &pad.fixs32[0], src0[0].fixs16[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[1].fixs32[0]);

    test_vlhff_32_vm(&vmo.fixs32, &pad.fixs32[0], src0[0].fixs16[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[2].fixs32[0]);

    /* sew 64 */
    test_vlhff_64(vlmax_64 - 1, &pad.fixs64[0], src0[0].fixs16[0], res0.fixs64[0]);
    result_compare_s64_lmul(res0.fixs64[0], dst0[0].fixs64[0]);

    test_vlhff_64_vm(&vme.fixs64, &pad.fixs64[0], src0[0].fixs16[0], res0.fixs64[0]);
    result_compare_s64_lmul(res0.fixs64[0], dst0[1].fixs64[0]);

    test_vlhff_64_vm(&vmo.fixs64, &pad.fixs64[0], src0[0].fixs16[0], res0.fixs64[0]);
    ...
    binv = (int16_t *)((uint64_t)binv + pagesize);
    /* sew 16 */
    start = (int16_t *)((uint64_t)brw + pagesize - 8 * 2);
    for (i = 0; i < 8; i++) {
        *(start + i) = src0[0].fixs16[0][i];
    }
    vl = test_vlhff_16(vlmax_16, &pad.fixs16[0], start, res0.fixs16[0]);
    ...
    vl = test_vlhff_32(vlmax_32, &pad.fixs32[0], start, res0.fixs32[0]);
    result_compare_s32(res0.fixs32[0], dst0[0].fixs32[0]);
    TEST(vl == vlmax_32 / 2);
    /* sew 64 */
    start = (int16_t *)((uint64_t)brw + pagesize - 2 * 2);
    for (i = 0; i < 2; i++) {
        *(start + i) = src0[0].fixs16[0][i];
    }
    vl = test_vlhff_64(vlmax_64, &pad.fixs64[0], start, res0.fixs64[0]);

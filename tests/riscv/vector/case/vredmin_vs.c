...
{
    int i = 0;
    init_testsuite("Testing insn vredmin.vs\n");

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredmin_vs_8(vlmax_8 - 1, src0[i].fixs8[0], src1[i].fixs8[0],
                res.fixs8[0], pad.fixs8[0]);
        result_compare_s8(res.fixs8[0], dst_vl[i].fixs8[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredmin_vs_8_vm(src0[i].fixs8[0], src1[i].fixs8[0],
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredmin_vs_16(vlmax_16 - 1, src0[i].fixs16[0],
                src1[i].fixs16[0], res.fixs16[0], pad.fixs16[0]);
        result_compare_s16(res.fixs16[0], dst_vl[i].fixs16[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredmin_vs_16_vm(src0[i].fixs16[0], src1[i].fixs16[0],
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredmin_vs_32(vlmax_32 - 1, src0[i].fixs32[0],
                src1[i].fixs32[0], res.fixs32[0], pad.fixs32[0]);
        result_compare_s32(res.fixs32[0], dst_vl[i].fixs32[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredmin_vs_32_vm(src0[i].fixs32[0], src1[i].fixs32[0],
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredmin_vs_64(vlmax_64 - 1, src0[i].fixs64[0],
                src1[i].fixs64[0], res.fixs64[0], pad.fixs64);
        result_compare_s64(res.fixs64[0], dst_vl[i].fixs64[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredmin_vs_64_vm(src0[i].fixs64[0], src1[i].fixs64[0],
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredminu_vs_8(vlmax_8 - 1, src0[i].fixu8[0], src1[i].fixu8[0],
                res.fixu8[0], pad.fixu8[0]);
        result_compare_s8(res.fixu8[0], dst_vl[i].fixu8[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredminu_vs_8_vm(src0[i].fixu8[0], src1[i].fixu8[0],
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredminu_vs_16(vlmax_16 - 1, src0[i].fixu16[0],
                src1[i].fixu16[0], res.fixu16[0], pad.fixu16[0]);
        result_compare_s16(res.fixu16[0], dst_vl[i].fixu16[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredminu_vs_16_vm(src0[i].fixu16[0], src1[i].fixu16[0],
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredminu_vs_32(vlmax_32 - 1, src0[i].fixu32[0],
                src1[i].fixu32[0], res.fixu32[0], pad.fixu32[0]);
        result_compare_s32(res.fixu32[0], dst_vl[i].fixu32[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredminu_vs_32_vm(src0[i].fixu32[0], src1[i].fixu32[0],
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredminu_vs_64(vlmax_64 - 1, src0[i].fixu64[0],
                src1[i].fixu64[0], res.fixu64[0], pad.fixu64);
        result_compare_s64(res.fixu64[0], dst_vl[i].fixu64[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vredminu_vs_64_vm(src0[i].fixu64[0], src1[i].fixu64[0],

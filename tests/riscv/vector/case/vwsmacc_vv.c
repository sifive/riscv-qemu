...
{
    int i = 0;
    init_testsuite("Testing insn vwsmacc.vv\n");

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vwsmacc_vv_8_rnu(vlmax_8 - 1, src0[i].fixs8, src1[i].fixs8,
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vwsmacc_vv_8_rne(src0[i].fixs8, src1[i].fixs8, src2[i].wfixs16,
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vwsmacc_vv_8_rdn(src0[i].fixs8, src1[i].fixs8, src2[i].wfixs16,
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vwsmacc_vv_8_rod(src0[i].fixs8, src1[i].fixs8, src2[i].wfixs16,
                res.wfixs16);
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vwsmacc_vv_16_rnu(vlmax_16 - 1, src0[i].fixs16, src1[i].fixs16,
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vwsmacc_vv_16_rne(src0[i].fixs16, src1[i].fixs16, src2[i].wfixs32,
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vwsmacc_vv_16_rdn(src0[i].fixs16, src1[i].fixs16, src2[i].wfixs32,
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vwsmacc_vv_16_rod(src0[i].fixs16, src1[i].fixs16, src2[i].wfixs32,
                res.wfixs32);
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vwsmacc_vv_32_rnu(vlmax_32 - 1, src0[i].fixs32, src1[i].fixs32,
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vwsmacc_vv_32_rne(src0[i].fixs32, src1[i].fixs32, src2[i].wfixs64,
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vwsmacc_vv_32_rdn(src0[i].fixs32, src1[i].fixs32, src2[i].wfixs64,
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vwsmacc_vv_32_rod(src0[i].fixs32, src1[i].fixs32, src2[i].wfixs64,
                res.wfixs64);

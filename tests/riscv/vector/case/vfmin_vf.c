...
struct rvv_reg dst_vl[] = {
    {
        ...
        .float32 = {
            {0xc843ca22, 0xc843ca22, 0xc843ca22, 0xc843ca22,},
            {0xc843ca22, 0xc843ca22, 0xff7fffff, 0x00000000,},
        },
        .float16 = {
            {0xcb85, 0xcb85, 0xcb85, 0xcb85, 0xcb85, 0xcb85, 0xcb85, 0xcb85,},
            {0xcb85, 0xcb85, 0xcb85, 0xcb85, 0xcb85, 0xcb85, 0xcb85, 0x0000,},
        },
    },
};
...
struct rvv_reg dst_even[] = {
    {
        ...
        .float32 = {
            {0xc843ca22, 0x11111111, 0xc843ca22, 0x11111111,},
            {0xc843ca22, 0x11111111, 0xff7fffff, 0x11111111,},
        },
        .float16 = {
            {0xcb85, 0x1111, 0xcb85, 0x1111, 0xcb85, 0x1111, 0xcb85, 0x1111,},
            {0xcb85, 0x1111, 0xcb85, 0x1111, 0xcb85, 0x1111, 0xcb85, 0x1111,},
        },
    },
};
...
struct rvv_reg dst_odd[] = {
    {
        ...
        .float32 = {
            {0x11111111, 0xc843ca22, 0x11111111, 0xc843ca22,},
            {0x11111111, 0xc843ca22, 0x11111111, 0xc843ca22,},
        },
        .float16 = {
            {0x1111, 0xcb85, 0x1111, 0xcb85, 0x1111, 0xcb85, 0x1111, 0xcb85,},
            {0x1111, 0xcb85, 0x1111, 0xcb85, 0x1111, 0xcb85, 0x1111, 0xcb85,},
        },
    },
};
...
int main(void)
{
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vfmin_vf_64(vlmax_64 - 1, src0[i].float64[0],
                src1[i].float64[0][0], res.float64[0], pad.fixu64);
        result_compare_s64_lmul(res.float64[0], dst_vl[i].float64[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vfmin_vf_64_vm(src0[i].float64[0], src1[i].float64[0][0],

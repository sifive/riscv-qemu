...
int main(void)
{
    init_testsuite("Testing insn vsxe\n");

    /* sew 8 */
    test_vsxe_8(vlmax_8 / 2, &pad.fixs8[0], src0[0].fixs8[0], src1[0].fixs8[0], res0.fixs8[0]);
    result_compare_s8_lmul(res0.fixs8[0], dst0[0].fixs8[0]);

    test_vsxe_8_vm(vlmax_8 / 2, &vme.fixs8, &pad.fixs8[0], src0[0].fixs8[0], src1[0].fixs8[0], res0.fixs8[0]);
    result_compare_s8_lmul(res0.fixs8[0], dst0[1].fixs8[0]);

    test_vsxe_8_vm(vlmax_8 / 2, &vmo.fixs8, &pad.fixs8[0], src0[0].fixs8[0], src1[0].fixs8[0], res0.fixs8[0]);
    result_compare_s8_lmul(res0.fixs8[0], dst0[2].fixs8[0]);

    /* sew 16 */
    test_vsxe_16(vlmax_16 / 2, &pad.fixs16[0], src0[0].fixs16[0], src1[0].fixs16[0], res0.fixs16[0]);
    result_compare_s16_lmul(res0.fixs16[0], dst0[0].fixs16[0]);

    test_vsxe_16_vm(vlmax_16 / 2, &vme.fixs16, &pad.fixs16[0], src0[0].fixs16[0], src1[0].fixs16[0], res0.fixs16[0]);
    result_compare_s16_lmul(res0.fixs16[0], dst0[1].fixs16[0]);

    test_vsxe_16_vm(vlmax_16 / 2, &vmo.fixs16, &pad.fixs16[0], src0[0].fixs16[0], src1[0].fixs16[0], res0.fixs16[0]);
    result_compare_s16_lmul(res0.fixs16[0], dst0[2].fixs16[0]);

    /* sew 32 */
    test_vsxe_32(vlmax_32 / 2, &pad.fixs32[0], src0[0].fixs32[0], src1[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[0].fixs32[0]);

    test_vsxe_32_vm(vlmax_32 / 2, &vme.fixs32, &pad.fixs32[0], src0[0].fixs32[0], src1[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[1].fixs32[0]);

    test_vsxe_32_vm(vlmax_32 / 2, &vmo.fixs32, &pad.fixs32[0], src0[0].fixs32[0], src1[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[2].fixs32[0]);

    /* sew 64 */
    test_vsxe_64(vlmax_64 / 2, &pad.fixs64[0], src0[0].fixs64[0], src1[0].fixs64[0], res0.fixs64[0]);
    result_compare_s64_lmul(res0.fixs64[0], dst0[0].fixs64[0]);

    test_vsxe_64_vm(vlmax_64 / 2, &vme.fixs64, &pad.fixs64[0], src0[0].fixs64[0], src1[0].fixs64[0], res0.fixs64[0]);
    result_compare_s64_lmul(res0.fixs64[0], dst0[1].fixs64[0]);

    test_vsxe_64_vm(vlmax_64 / 2, &vmo.fixs64, &pad.fixs64[0], src0[0].fixs64[0], src1[0].fixs64[0], res0.fixs64[0]);

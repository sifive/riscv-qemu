...
struct rvv_reg dst_vl[] = {
    {
        .float64 = {
            {0x7fefffffffffffff, 0xffefffffffffffff,},
            {0x40331ed72ee61c6d, 0x0000000000000000,},
        },
        .float32 = {
            {0xc67582b0, 0x485ad7c4, 0xc7e38e88, 0x7f7fffff,},
            {0xc67582b0, 0x485ad7c4, 0xff7fffff, 0x00000000,},
        },
        .float16 = {
            {0xbcb8, 0x4c34, 0xc85e, 0x4cb7, 0xbc60, 0x4bc2, 0xc808, 0x4c5a,},
            {0x7bff, 0x4c34, 0xfbff, 0x4cb7, 0xbc60, 0x4bc2, 0xc808, 0x0000,},
        },
    },
};
...
struct rvv_reg dst_even[] = {
    {
        .float64 = {
            ...
            {0x40331ed72ee61c6d, 0x1111111111111111,},
        },
        .float32 = {
            {0xc67582b0, 0x11111111, 0xc7e38e88, 0x11111111,},
            {0xc67582b0, 0x11111111, 0xff7fffff, 0x11111111,},
        },
        .float16 = {
            {0xbcb8, 0x1111, 0xc85e, 0x1111, 0xbc60, 0x1111, 0xc808, 0x1111,},
            {0x7bff, 0x1111, 0xfbff, 0x1111, 0xbc60, 0x1111, 0xc808, 0x1111,},
        },
    },
};
...
struct rvv_reg dst_odd[] = {
    {
        .float64 = {
            ...
            {0x1111111111111111, 0xc04d042f8cbb56fc,},
        },
        .float32 = {
            {0x11111111, 0x485ad7c4, 0x11111111, 0x7f7fffff,},
            {0x11111111, 0x485ad7c4, 0x11111111, 0x4875a4da,},
        },
        .float16 = {
            {0x1111, 0x4c34, 0x1111, 0x4cb7, 0x1111, 0x4bc2, 0x1111, 0x4c5a,},
            {0x1111, 0x4c34, 0x1111, 0x4cb7, 0x1111, 0x4bc2, 0x1111, 0x4c5a,},
        },
    },
};
...
int main(void)
{
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vfadd_vv_64(vlmax_64 - 1, src0[i].float64[0],
                src1[i].float64[0], res.float64[0], pad.fixu64);
        result_compare_s64_lmul(res.float64[0], dst_vl[i].float64[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vfadd_vv_64_vm(src0[i].float64[0], src1[i].float64[0],

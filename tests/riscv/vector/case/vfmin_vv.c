...
struct rvv_reg dst_vl[] = {
    {
        ...
        .float32 = {
            {0xc843ca22, 0x46f2e02b, 0xc785dc35, 0x47ad69d9,},
            {0xc843ca22, 0x46f2e02b, 0xff7fffff, 0x00000000,},
        },
        .float16 = {
            {0xcb85, 0x40aa, 0xc524, 0x46a9, 0xcaf1, 0x404e, 0xc4bf, 0x4626,},
            {0x4aee, 0x40aa, 0xfbff, 0x46a9, 0xcaf1, 0x404e, 0xc4bf, 0x0000,},
        },
    },
};
...
struct rvv_reg dst_even[] = {
    {
        ...
        .float32 = {
            {0xc843ca22, 0x11111111, 0xc785dc35, 0x11111111,},
            {0xc843ca22, 0x11111111, 0xff7fffff, 0x11111111,},
        },
        .float16 = {
            {0xcb85, 0x1111, 0xc524, 0x1111, 0xcaf1, 0x1111, 0xc4bf, 0x1111,},
            {0x4aee, 0x1111, 0xfbff, 0x1111, 0xcaf1, 0x1111, 0xc4bf, 0x1111,},
        },
    },
};
...
int main(void)
{
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vfmin_vv_64(vlmax_64 - 1, src0[i].float64[0],
                src1[i].float64[0], res.float64[0], pad.fixu64);
        result_compare_s64_lmul(res.float64[0], dst_vl[i].float64[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vfmin_vv_64_vm(src0[i].float64[0], src1[i].float64[0],

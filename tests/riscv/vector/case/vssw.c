...
int main(void)
{
    init_testsuite("Testing insn vssw\n");

    /* sew 32 */
    test_vssw_32(vlmax_32 / 2, &pad.fixs32[0], src0[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[0].fixs32[0]);

    test_vssw_32_vm(vlmax_32 / 2, &vme.fixs32, &pad.fixs32[0], src0[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[1].fixs32[0]);

    test_vssw_32_vm(vlmax_32 / 2, &vmo.fixs32, &pad.fixs32[0], src0[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[2].fixs32[0]);

    /* sew 64 */
    test_vssw_64(vlmax_64 / 2, &pad.fixs32[0], src0[0].fixs64[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst1[0].fixs32[0]);

    test_vssw_64_vm(vlmax_64 / 2, &vme.fixs64, &pad.fixs32[0], src0[0].fixs64[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst1[1].fixs32[0]);

    test_vssw_64_vm(vlmax_64 / 2, &vmo.fixs64, &pad.fixs32[0], src0[0].fixs64[0], res0.fixs32[0]);

...
struct rvv_reg dst_vl[] = {
    {
        ...
        .float32 = {
            {0xc67582b0, 0xc8256e1d, 0xc8835c1e, 0xc7da2a6b,},
            {0xc67582b0, 0xc8256e1d, 0xff7fffff, 0x00000000,},
        },
        .float16 = {
            {0xbcb8, 0xca5a, 0xcd0c, 0xc830, 0xc080, 0xca72, 0xccf2, 0xc872,},
            {0xbcb8, 0xca5a, 0xcd0c, 0xc830, 0xc080, 0xca72, 0xccf2, 0x0000,},
        },
    },
};
...
struct rvv_reg dst_even[] = {
    {
        ...
        .float32 = {
            {0xc67582b0, 0x11111111, 0xc8835c1e, 0x11111111,},
            {0xc67582b0, 0x11111111, 0xff7fffff, 0x11111111,},
        },
        .float16 = {
            {0xbcb8, 0x1111, 0xcd0c, 0x1111, 0xc080, 0x1111, 0xccf2, 0x1111,},
            {0xbcb8, 0x1111, 0xcd0c, 0x1111, 0xc080, 0x1111, 0xccf2, 0x1111,},
        },
    },
};
...
struct rvv_reg dst_odd[] = {
    {
        .float64 = {
            ...
            {0x1111111111111111, 0xc0351c9532742c15,},
        },
        .float32 = {
            {0x11111111, 0xc8256e1d, 0x11111111, 0xc7da2a6b,},
            {0x11111111, 0xc8256e1d, 0x11111111, 0xc7da2a6b,},
        },
        .float16 = {
            {0x1111, 0xca5a, 0x1111, 0xc830, 0x1111, 0xca72, 0x1111, 0xc872,},
            {0x1111, 0xca5a, 0x1111, 0xc830, 0x1111, 0xca72, 0x1111, 0xc872,},
        },
    },
};
...
int main(void)
{
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vfadd_vf_64(vlmax_64 - 1, src0[i].float64[0],
                src1[i].float64[0][0], res.float64[0], pad.fixu64);
        result_compare_s64_lmul(res.float64[0], dst_vl[i].float64[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vfadd_vf_64_vm(src0[i].float64[0], src1[i].float64[0][0],

...
struct rvv_reg dst0[] = {
    {
        ...
        .fixs64 = {
            {0x00000000ffffffa5, 0x00000000ffffffcd, },
            {0x0000000000000060, 0x00000000fffffffd, },
        },
    },
    {
        .fixs32 = {
    ...
    },
    {
        ...
        .fixs64 = {
            {0x1111111111111111, 0x00000000ffffffcd, },
            {0x1111111111111111, 0x00000000fffffffd, },
        },
    },
};
...
int main(void)
{
    init_testsuite("Testing insn vlswu\n");

    /* sew 32 */
    test_vlswu_32(vlmax_32 / 2, &pad.fixs32[0], src0[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[0].fixs32[0]);

    test_vlswu_32_vm(vlmax_32 / 2, &vme.fixs32, &pad.fixs32[0], src0[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[1].fixs32[0]);

    test_vlswu_32_vm(vlmax_32 / 2, &vmo.fixs32, &pad.fixs32[0], src0[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[2].fixs32[0]);

    /* sew 64 */
    test_vlswu_64(&pad.fixs64[0], src0[0].fixs32[0], res0.fixs64[0]);
    result_compare_s64_lmul(res0.fixs64[0], dst0[0].fixs64[0]);

    test_vlswu_64_vm(&vme.fixs64, &pad.fixs64[0], src0[0].fixs32[0], res0.fixs64[0]);
    result_compare_s64_lmul(res0.fixs64[0], dst0[1].fixs64[0]);

    test_vlswu_64_vm(&vmo.fixs64, &pad.fixs64[0], src0[0].fixs32[0], res0.fixs64[0]);

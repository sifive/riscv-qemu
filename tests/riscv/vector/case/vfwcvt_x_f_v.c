...
struct rvv_reg dst_vl[] = {
    {
        .wfloat64 = {
            ...
            {0x7fffffffffffffff, 0x0000000000007970, 0x8000000000000000, 0x0000000000000000,}, 
        },
        .wfloat32 = {
            {0x00000000e, 0x00000002, 0xfffffffb, 0x00000007, 0x0000000d, 0x00000002, 0xfffffffb, 0x00000006,},
            {0x00000000e, 0x7fffffff, 0xfffffffb, 0x80000000, 0x0000000d, 0x00000002, 0xfffffffb, 0x00000000,}, 
        },
    },
};
...
struct rvv_reg dst_even[] = {
    {
        .wfloat64 = {
            {0x000000000002d1c8, 0x1111111111111111, 0xfffffffffffef448, 0x1111111111111111,},
            {0x7fffffffffffffff, 0x1111111111111111, 0x8000000000000000, 0x1111111111111111,}, 
        },
        .wfloat32 = {
            {0x0000000e, 0x11111111, 0xfffffffb, 0x11111111, 0x0000000d, 0x11111111, 0xfffffffb, 0x11111111,},
            {0x0000000e, 0x11111111, 0xfffffffb, 0x11111111, 0x0000000d, 0x11111111, 0xfffffffb, 0x11111111,}, 
        },
    },
};
...
struct rvv_reg dst_odd[] = {
    {
        ...
        .wfloat32 = {
            ...
            {0x11111111, 0x7fffffff, 0x11111111, 0x80000000, 0x11111111, 0x00000002, 0x11111111, 0x00000006,}, 
        },
    },
};
...
int main(void)
{
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vfwcvt_x_f_v_32(vlmax_32 - 1, src0[i].float32[0],
                src1[i].float32[0], res.wfloat64[0], pad.fixu32[0]);
        result_compare_s64_lmul(res.wfloat64[0], dst_vl[i].wfloat64[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vfwcvt_x_f_v_32_vm(src0[i].float32[0], src1[i].float32[0],

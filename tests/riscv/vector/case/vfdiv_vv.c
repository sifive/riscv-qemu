...
struct rvv_reg dst_vl[] = {
    {
        ...
        .float32 = {
            ...
            {0xbf6befd1, 0x3e24f025, 0x77aedcbf, 0x00000000,},
        },
        .float16 = {
            {0xbb5f, 0x3128, 0x3db7, 0x385e, 0xbb5f, 0x3128, 0x3db8, 0x385e,},
            {0x0aef, 0x3128, 0x0525, 0x385e, 0xbb5f, 0x3128, 0x3db8, 0x0000,},
        },
    },
};
...
struct rvv_reg dst_even[] = {
    {
        ...
        .float32 = {
            {0xbf6befd1, 0x11111111, 0x3fb6de33, 0x11111111,},
            {0xbf6befd1, 0x11111111, 0x77aedcbf, 0x11111111,},
        },
        .float16 = {
            {0xbb5f, 0x1111, 0x3db7, 0x1111, 0xbb5f, 0x1111, 0x3db8, 0x1111,},
            {0x0aef, 0x1111, 0x0525, 0x1111, 0xbb5f, 0x1111, 0x3db8, 0x1111,},
        },
    },
};
...
struct rvv_reg dst_odd[] = {
    {
        .float64 = {
            {0x1111111111111111, 0x7fa62445141b1068,},
            {0x1111111111111111, 0x3ff8278813019c49,},
        },
        .float32 = {
            {0x11111111, 0x3e24f025, 0x11111111, 0x07ad69da,},
            {0x11111111, 0x3e24f025, 0x11111111, 0x3f0ba88f,},
        },
        .float16 = {
            {0x1111, 0x3128, 0x1111, 0x385e, 0x1111, 0x3128, 0x1111, 0x385e,},
            {0x1111, 0x3128, 0x1111, 0x385e, 0x1111, 0x3128, 0x1111, 0x385e,},
        },
    },
};
...
int main(void)
{
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vfdiv_vv_64(vlmax_64 - 1, src0[i].float64[0],
                src1[i].float64[0], res.float64[0], pad.fixu64);
        result_compare_s64_lmul(res.float64[0], dst_vl[i].float64[0]);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct rvv_reg); i++) {
        test_vfdiv_vv_64_vm(src0[i].float64[0], src1[i].float64[0],

...
struct rvv_reg src1[] = {
    {
         .fixs16 = {
            {0x0000, 0x0008, 0x0010, 0x0018, 0x0020, 0x0020, 0x0020, 0x0020, },
...
int main(void)
{
    init_testsuite("Testing insn vsxseg2e\n");

    /* sew 16 */
    test_vsxseg2e_16(&pad.fixs16[0], src0[0].fixs16[0], src0[1].fixs16[0], src1[0].fixs16, res0.fixs16[0]);

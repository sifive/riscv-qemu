...
struct rvv_reg dst1[] = {
    {
        .fixs32 = {
            {0xffffffa5, 0x00000034, 0xffffff8c, 0x11111111, },
...
int main(void)
{
    init_testsuite("Testing insn vsw\n");

    /* sew 32 */
    test_vsw_32(vlmax_32 - 1, &pad.fixs32[0], src0[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[0].fixs32[0]);

    test_vsw_32_vm(&vme.fixs32, &pad.fixs32[0], src0[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[1].fixs32[0]);

    test_vsw_32_vm(&vmo.fixs32, &pad.fixs32[0], src0[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst0[2].fixs32[0]);

    /* sew 64 */
    test_vsw_64(vlmax_64 - 1, &pad.fixs32[0], src0[0].fixs64[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst1[0].fixs32[0]);

    test_vsw_64_vm(&vme.fixs64, &pad.fixs32[0], src0[0].fixs64[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst1[1].fixs32[0]);

    test_vsw_64_vm(&vmo.fixs64, &pad.fixs32[0], src0[0].fixs64[0], res0.fixs32[0]);
